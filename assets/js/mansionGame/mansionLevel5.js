...
class MansionLevel5 {
  constructor(gameEnv) {
	...
	const sprite_data_player = {
        ...
        downRight: {row: 0, start: 0, columns: 1, rotate: Math.PI/4 },
        downLeft: {row: 0, start: 0, columns: 1, mirror: true, rotate: -Math.PI/4 },
        left: {row: 0, start: 0, columns: 1, mirror: true },
        right: {row: 0, start: 0, columns: 1},
        up: {row: 0, start: 0, columns: 1},
        upLeft: {row: 0, start: 0, columns: 1, mirror: true, rotate: Math.PI/4 },
