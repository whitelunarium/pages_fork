...
class MansionLevel5 {
  constructor(gameEnv) {
	...
	const sprite_data_player = {
		...
		downRight: {row: 1, start: 0, columns: 1, rotate: Math.PI/4 /*45 degrees in radians */},
		downLeft: {row: 1, start: 0, columns: 1, rotate: -Math.PI/4 /*45 degrees in radians */},
		left: {row: 1, start: 0, columns: 1 },
		right: {row: 1, start: 0, columns: 1 },
		up: {row: 1, start: 0, columns: 1 },
		upLeft: {row: 1, start: 0, columns: 1, rotate: Math.PI/4/*45 degrees in radians */ },
		upRight: {row: 1, start: 0, columns: 1, rotate: -Math.PI/4 /*45 degrees in radians */},
