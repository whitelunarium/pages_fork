...
### <span style="color:#fa709a">🎨 Challenge 4: Design Your Own!</span>

<div style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 25px; border-radius: 15px; color: white;">
  <p style="font-size: 1.1em; margin: 0 0 15px 0;">Now it's your turn to create prompts from scratch. Choose one scenario:</p>

  <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 10px; margin: 10px 0;">
    <strong>1. 🍳 The Recipe Creator</strong> - Get AI to create a custom recipe
  </div>

  <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 10px; margin: 10px 0;">
    <strong>2. 📖 The Study Buddy</strong> - Ask AI to help you understand a difficult concept
  </div>

  <div style="background: rgba(255,255,255,0.2); padding: 15px; border-radius: 10px; margin: 10px 0;">
    <strong>3. 🎮 The Game Designer</strong> - Have AI help design a simple game
  </div>
</div>
